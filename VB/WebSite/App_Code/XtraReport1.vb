...
Public Class XtraReport1
    ...
    Public Sub New(ByVal tableName As String)
        ...
        If rowsCount > 0 Then
            ...
            Dim dynamicTable As XRTable = XRTable.CreateTable(New Rectangle(padding, 2, tableWidth, 40), 1, 0) ' table column count -  table row count -  height -  width -  rect Y -  rect X
